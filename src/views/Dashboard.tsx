...
const StatCard = ({ icon: Icon, label, value, unit, color, trend }: any) => (
  ...
  >
    <div className="flex items-start justify-between mb-4">
      ...
      {trend && (
        <span
          className={`text-xs font-bold px-2 py-1 rounded-lg ${trend > 0 ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}
        >
          {trend > 0 ? "+" : ""}
          {trend}%
        </span>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-sm text-zinc-500 font-medium">
                  Weekly steps and calorie trends
                </p>
              </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
              ...
              <div className="space-y-4">
                {mockWorkouts.slice(0, 3).map((workout) => (
                  <div
                    key={workout.id}
                    className="flex items-center gap-4 p-4 rounded-2xl hover:bg-zinc-50 transition-colors group cursor-pointer border border-transparent hover:border-zinc-100"
                  >
            ...
            <div className="bg-zinc-900 p-8 rounded-[2rem] text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  Based on your sleep quality and heart rate variability, you're
                  in the optimal zone for a high-intensity session.
                </p>
        ...
        <div className="space-y-8">
          <section className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
            ...
            <div className="mt-8 pt-6 border-t border-zinc-100">
              ...
              <p className="text-center text-xs font-medium text-zinc-500 mt-3">
                2.4L of 3.2L consumed
              </p>
            </div>
          </section>
