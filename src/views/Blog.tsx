  ...
  const posts = [
    {
      ...
      excerpt:
        "Quality sleep is the foundation of any successful fitness journey. Learn how to optimize your rest...",
    ...
    },
    {
      ...
      excerpt:
        "Protein is essential for muscle growth, but more isn't always better. We break down the science...",
    ...
    },
    {
      ...
      excerpt:
        "The squat is the king of all exercises, but poor form can lead to injury. Here's how to do it right...",
      author: "Coach Alex",
      date: "May 18, 2024",
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 bg-white border border-zinc-200 rounded-2xl focus:ring-2 focus:ring-brand-500/20 outline-none text-sm font-medium"
          />
        </div>
      </header>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            ...
            <div className="p-8">
              ...
              <h2 className="text-2xl font-display font-bold text-zinc-900 mb-3 group-hover:text-brand-600 transition-colors">
                {posts[0].title}
              </h2>
            ...
            {posts.slice(1).map((post, idx) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-display font-bold text-zinc-900 mb-2 group-hover:text-brand-600 transition-colors line-clamp-2">
                    {post.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-zinc-50">
                    ...
                    <ChevronRight
                      size={18}
                      className="text-zinc-300 group-hover:text-brand-600 transition-colors"
                    />
                  </div>
                </div>
              </motion.div>
          ...
          <section className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
            ...
            <div className="space-y-2">
              {[
                ...
                >
                  <span className="text-sm font-bold text-zinc-600 group-hover:text-zinc-900">
                    {cat}
                  </span>
                  <span className="text-xs font-bold text-zinc-400 bg-zinc-100 px-2 py-0.5 rounded-lg group-hover:bg-brand-100 group-hover:text-brand-600 transition-colors">
                    12
                  </span>
                </button>
              ))}
          ...
          <section className="bg-zinc-900 p-8 rounded-[2rem] text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
                Get the latest fitness insights and AI tips delivered to your
                inbox.
              </p>
              <input
                type="email"
                placeholder="Your email"
                className="w-full bg-white/10 border-none rounded-xl py-3 px-4 text-sm mb-3 focus:ring-2 focus:ring-brand-500/50 outline-none"
              />
          ...
          <section className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  key={tag}
                  className="px-3 py-1.5 bg-zinc-100 text-zinc-600 rounded-xl text-xs font-bold hover:bg-brand-50 hover:text-brand-600 transition-colors"
                >
                  {tag}
                </button>
              ))}
