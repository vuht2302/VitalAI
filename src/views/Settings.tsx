          ...
          {activeTab === "profile" && (
            ...
            >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-zinc-50 border-none rounded-2xl focus:ring-2 focus:ring-brand-500/20 outline-none font-medium"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
              ...
              <div className="flex items-center justify-end gap-4">
                <button className="px-6 py-3 text-sm font-bold text-zinc-500 hover:text-zinc-900 transition-colors">
                  Cancel
                </button>
                  ...
                  <div className="space-y-4 p-6 bg-zinc-50 rounded-3xl border border-zinc-100">
                    ...
                    <div className="flex items-baseline gap-2">
                      <input
                        ...
                        className="w-20 bg-transparent border-b-2 border-zinc-200 text-2xl font-display font-bold text-zinc-900 outline-none focus:border-brand-500"
                      />
              ...
              <div className="bg-brand-600 p-8 rounded-[2rem] text-white flex items-center justify-between shadow-lg shadow-brand-200">
                <div className="space-y-2">
                  ...
                  <p className="text-brand-100 text-sm max-w-md">
                    Update your measurements every 2 weeks for the most accurate
                ...
                {[
                  {
                    ...
                    desc: "Get notified when it's time for your scheduled workout.",
                  },
                  {
                    title: "Meal Tracking",
                    desc: "Reminders to log your breakfast, lunch, and dinner.",
                  },
                  {
                    title: "AI Insights",
                    desc: "Receive personalized health tips and performance analysis.",
                  },
                  {
                    title: "Weekly Progress Report",
                    desc: "A summary of your weekly achievements and stats.",
                  },
                  {
                    title: "Social Interactions",
                    desc: "When friends like your workouts or comment on progress.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
