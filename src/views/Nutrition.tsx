  ...
  const stats = [
    {
      ...
      value: "1,842",
      unit: "kcal",
      info: "Basal Metabolic Rate",
    },
    {
      label: "TDEE",
      value: "2,650",
      unit: "kcal",
      info: "Total Daily Energy Expenditure",
    },
    {
      label: "Daily Target",
      value: "2,150",
      unit: "kcal",
      info: "Current Calorie Goal",
    },
  ];
    ...
    <div className="space-y-8 pb-12">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-zinc-500 font-medium mt-1">
            Fuel your body with precision and AI guidance.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm group"
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <Info
                size={16}
                className="text-zinc-300 group-hover:text-zinc-500 transition-colors cursor-help"
              />
            </div>
                ...
                <div key={macro.label} className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div
                        className={`p-2 rounded-lg ${macro.color} bg-opacity-10 text-opacity-100`}
                      >
                        <macro.icon
                          size={16}
          ...
          <section className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
            ...
            <div className="space-y-6">
              {mockMeals.map((meal) => (
                <div
                  key={meal.id}
                  className="flex items-center gap-6 p-4 rounded-2xl hover:bg-zinc-50 transition-all group cursor-pointer border border-transparent hover:border-zinc-100"
                >
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6">
              <div className="flex gap-3">
                ...
                <div className="bg-white/10 p-4 rounded-2xl rounded-tl-none text-sm leading-relaxed">
                  Hi {mockUser.name.split(" ")[0]}! I've analyzed your lunch.
                  You're slightly low on protein for your gain goal. Would you
                  like a high-protein snack recommendation?
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="bg-white/10 p-4 rounded-2xl rounded-tl-none text-sm leading-relaxed">
                  I recommend a Greek yogurt with a handful of almonds. It's
                  about 25g of protein and will keep you full until dinner!
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-zinc-50 rounded-2xl border-l-4 border-brand-500">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Drinking water before meals can help with portion control and
                  metabolism.
                </p>
              </div>
              <div className="p-4 bg-zinc-50 rounded-2xl border-l-4 border-orange-500">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  Eat complex carbs 2-3 hours before training for sustained
                  energy levels.
                </p>
              </div>
            </div>
